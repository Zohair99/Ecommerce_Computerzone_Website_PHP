...
if (isset($_GET['delete_id'])) {
    ...
    // DELETE query
    $delete_query = "DELETE FROM hdd_data WHERE id = $id LIMIT 1";

    if (mysqli_query($conn, $delete_query)) {
        echo "<script>alert('Product deleted successfully.'); window.location.href='view_hdd.php';</script>";
    } else {
...
$fetch_query = "SELECT * FROM hdd_data";
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this product?")) {
                window.location.href = "view_hdd.php?delete_id=" + id;
            }
        }
    </script>
</head>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_hdd.php?edit_id=<?php echo $id; ?>" class="action-icons edit-icon">
