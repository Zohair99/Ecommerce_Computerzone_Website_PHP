...
// Fetch dropdown data
$store_query = "SELECT * FROM headsetheadphonemic_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM headsetheadphonemic_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $processor = mysqli_real_escape_string($conn, $_POST['brand_dropdown']);
    ...
    $update_query = "UPDATE headsetheadphonemic SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Product updated successfully.'); window.location.href='view_headset-headphone-mic.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM headsetheadphonemic WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Headset Product</title>
    <style>
