...
$store_query = "SELECT * FROM carttrones_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM carttrones_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE carttrones SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Cart Trones record updated successfully.'); window.location.href='view_carttrones.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM carttrones WHERE id='$edit_id'";
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Cart Trones item not found.</p>
<?php } ?>
</body>
</html>
