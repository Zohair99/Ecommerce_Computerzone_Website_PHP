...
if (isset($_GET['delete_id'])) {
    ...
    if (mysqli_query($conn, $delete_query)) {
        echo "<script>alert('Product deleted successfully.'); window.location.href='view_laptop.php';</script>";
    } else {
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this product?")) {
                window.location.href = "view_laptop.php?delete_id=" + id;
            }
        }
    </script>
</head>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_laptop.php?edit_id=<?php echo $id; ?>" class="action-icons edit-icon">
