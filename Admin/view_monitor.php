...
if (isset($_GET['delete_id'])) {
    ...
    // DELETE query
    $delete_query = "DELETE FROM monitor WHERE id = $id LIMIT 1";

    if (mysqli_query($conn, $delete_query)) {
        echo "<script>alert('Product deleted successfully.'); window.location.href='view_monitor.php';</script>";
    } else {
...
$fetch_query = "SELECT * FROM monitor";
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this product?")) {
                window.location.href = "view_monitor.php?delete_id=" + id;
            }
        }
    </script>
</head>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_monitor.php?edit_id=<?php echo $id; ?>" class="action-icons edit-icon">
