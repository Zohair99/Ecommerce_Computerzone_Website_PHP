...
if (isset($_GET['delete_id'])) {
    ...
    // DELETE query
    $delete_query = "DELETE FROM New_Home WHERE id = $id LIMIT 1";
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $status = isset($row['status']) ? ($row['status'] ? 'true' : 'false') : 'false';
            ?>
            <tr>
                <td><?php echo $id; ?></td>
                <td><?php echo $name; ?></td>
                ...
                <td>
                <a href="edit_newarrivals.php?edit_id=<?php echo $id; ?>" class="action-icons edit-icon">
