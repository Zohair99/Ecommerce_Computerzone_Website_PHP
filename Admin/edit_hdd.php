...
$capacity_query = "SELECT * FROM capacity";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $hd = mysqli_real_escape_string($conn, $_POST['hd_dropdown']); // Use hd name
    ...
    // Update query
    $update_query = "UPDATE hdd_data SET 
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM hdd_data WHERE id='$edit_id'";
...
<?php if ($edit_data) { ?>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <select name="hd_dropdown" required>
            <option value="">Select Hard Disk</option>
            <?php
            mysqli_data_seek($hdd_result, 0);
            while ($hdd = mysqli_fetch_assoc($hdd_result)) { ?>
                <option value="<?php echo $hdd['hard_disk']; ?>" 
                    <?php if (isset($edit_data['hd']) && $edit_data['hd'] == $hdd['hard_disk']) echo 'selected'; ?>>
                    <?php echo htmlspecialchars($hdd['hard_disk']); ?>
                </option>
            <?php } ?>
        </select>
