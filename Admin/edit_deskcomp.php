...
// Fetch dropdown data
$store_query = "SELECT * FROM deskcomp_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM deskcomp_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE deskcomp SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Deskcomp product updated successfully.'); window.location.href='view_deskcomp.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM deskcomp WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Deskcomp Product</title>
    <style>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Deskcomp product not found.</p>
<?php } ?>
</body>
</html>
