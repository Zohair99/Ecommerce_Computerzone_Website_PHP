...
// Fetch dropdown data
$store_query = "SELECT * FROM casing_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM casing_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE casing SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Casing record updated successfully.'); window.location.href='view_casing.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM casing WHERE id='$edit_id'";
...
<?php if ($edit_data) { ?>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <label>Brand (casing_store):</label>
        ...
        <label>Processor (casing_brand):</label>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Casing product not found.</p>
<?php } ?>
</body>
</html>
