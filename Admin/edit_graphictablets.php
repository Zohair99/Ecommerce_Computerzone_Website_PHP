...
// Fetch dropdown data
$store_query = "SELECT * FROM graphictablets_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM graphictablets_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE graphictablets SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Graphic tablet updated successfully.'); window.location.href='view_graphictablets.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM graphictablets WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Graphic Tablet</title>
    <style>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Graphic tablet not found.</p>
<?php } ?>
</body>
</html>
