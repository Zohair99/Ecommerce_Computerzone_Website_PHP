...
// Fetch dropdown data
$store_query = "SELECT * FROM cooling_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM cooling_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE cooling SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Cooling product updated successfully.'); window.location.href='view_cooling.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM cooling WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Cooling Product</title>
    <style>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Cooling product not found.</p>
<?php } ?>
</body>
</html>
