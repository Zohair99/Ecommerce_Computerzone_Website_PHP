...
if (isset($_GET['delete_id'])) {
    ...
    // DELETE query from 'pos' table
    $delete_query = "DELETE FROM pos WHERE id = $id LIMIT 1";

    if (mysqli_query($conn, $delete_query)) {
        echo "<script>alert('Product deleted successfully.'); window.location.href='view_pos.php';</script>"; 
    } else {
        echo "<script>alert('Error deleting product: " . mysqli_error($conn) . "');</script>";
    }
}

$fetch_query = "SELECT * FROM pos";
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Are you sure you want to delete this product?")) {
                window.location.href = "view_pos.php?delete_id=" + id;
            }
        }
    </script>
</head>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_pos.php?edit_id=<?php echo $id; ?>" class="action-icons edit-icon"> <i class="fa fa-pencil-alt"></i>
                    </a>
                </td>
                <td>
            ...
            <?php
                ...
                echo "<tr><td colspan='6'>No POS products found.</td></tr>"; 
            }
