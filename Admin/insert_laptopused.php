...
if (isset($_POST['btn'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if (move_uploaded_file($temp, $final)) {
            ...
            $insert_query = "INSERT INTO laptopused 
...
$brand_result = mysqli_query($conn, "SELECT * FROM laptopused_store");
$processor_result = mysqli_query($conn, "SELECT * FROM processor_store");
?>
...
<body>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label for="processor_dropdown">Select Processor</label>
