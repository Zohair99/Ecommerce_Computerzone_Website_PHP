...
// Fetch dropdown data
$brand_query = "SELECT * FROM laptopacc_store";
$brand_result = mysqli_query($conn, $brand_query);

$processor_query = "SELECT * FROM brand_store";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE laptopacc SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Laptop record updated successfully.'); window.location.href='view_laptopacc.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM laptopacc WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Laptop Accessory</title>
    <style>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Laptop accessory not found.</p>
<?php } ?>
</body>
</html>
