...
// Fetch dropdown data
$store_query = "SELECT * FROM gamingproducts_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM gamingproducts_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE gamingproducts SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Gaming product updated successfully.'); window.location.href='view_gamingproducts.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM gamingproducts WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Gaming Product</title>
    <style>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Gaming product not found.</p>
<?php } ?>
</body>
</html>
