...
// Fetch mouse store and brand for the dropdowns
$store_query = "SELECT * FROM mouse_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM mouse_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Product updated successfully.'); window.location.href='view_mouse.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM mouse WHERE id='$edit_id'";
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <select name="brand_dropdown" required>
            ...
            while ($store = mysqli_fetch_assoc($store_result)) { ?>
                <option value="<?php echo $store['mousestore']; ?>" 
                    <?php if (isset($edit_data['brand']) && $edit_data['brand'] == $store['mousestore']) echo 'selected'; ?>>
                    <?php echo htmlspecialchars($store['mousestore']); ?>
                </option>
            <?php } ?>
        </select>
        ...
        <select name="processor_dropdown" required>
            ...
            while ($brand = mysqli_fetch_assoc($brand_result)) { ?>
                <option value="<?php echo $brand['mousebrand']; ?>" 
                    <?php if (isset($edit_data['processor']) && $edit_data['processor'] == $brand['mousebrand']) echo 'selected'; ?>>
                    <?php echo htmlspecialchars($brand['mousebrand']); ?>
                </option>
            <?php } ?>
        </select>
