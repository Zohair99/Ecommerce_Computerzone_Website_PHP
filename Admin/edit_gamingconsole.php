...
// Fetch dropdown data
$store_query = "SELECT * FROM gamingconsoles_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM gamingconsoles_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE gamingconsoles SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Gaming console updated successfully.'); window.location.href='view_gamingconsole.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM gamingconsoles WHERE id='$edit_id'";
...
<head>
    <meta charset="UTF-8">
    <title>Edit Gaming Console Product</title>
    <style>
...
<?php if ($edit_data) { ?>
    <h2>Edit Gaming Console Product</h2>
...
<?php } else { ?>
    <p style="color:red; text-align:center;">Gaming console not found.</p>
<?php } ?>
</body>
</html>
