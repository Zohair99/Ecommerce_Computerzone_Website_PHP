...
// Fetch dropdown data
$store_query = "SELECT * FROM keyboard_store";
$store_result = mysqli_query($conn, $store_query);

$brand_query = "SELECT * FROM keyboard_brand";
...
if (isset($_POST['update_product']) && isset($_POST['update_id'])) {
    ...
    $update_query = "UPDATE keyboard SET
                    offer='$offer',
                    name='$name',
                    review='$review',
                    code='$code',
    ...
    if (mysqli_query($conn, $update_query)) {
        echo "<script>alert('Keyboard product updated successfully.'); window.location.href='view_keyboard.php';</script>";
    } else {
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_query = "SELECT * FROM keyboard WHERE id='$edit_id'";
