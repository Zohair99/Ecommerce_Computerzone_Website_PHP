...
$title = 'MotherBoard Prices in Pakistan - Computer Zone';
...
$sort_order = "motherboard.price ASC";
if (isset($_GET['sort'])) {
    switch ($_GET['sort']) {
        case "high":
            $sort_order = "motherboard.price DESC";
            break;
        case "low":
            $sort_order = "motherboard.price ASC";
            break;
        case "rating":
            $sort_order = "motherboard.review DESC";
            break;
        default:
            $sort_order = "motherboard.price ASC";
    }
...
if (!empty($selected_brand)) {
    $where_clauses[] = "motherboard_store.motherboardstore = ?";
    $params[] = $selected_brand;
    $types .= 's';
}

if (!empty($selected_processor)) {
    $where_clauses[] = "motherboard_brand.motherboardbrand = ?";
    $params[] = $selected_processor;
    $types .= 's';
}

if (!empty($searchQuery)) {
    $where_clauses[] = "motherboard.name LIKE ?";
    $params[] = '%' . $searchQuery . '%';
    $types .= 's';
}
...
$total_products_query = "SELECT COUNT(*) as total
                         FROM motherboard
                         INNER JOIN motherboard_store ON motherboard.brand = motherboard_store.motherboardstore
                         INNER JOIN motherboard_brand ON motherboard.processor = motherboard_brand.motherboardbrand"
                         . $where_clause_string;
...
$product_query = "SELECT motherboard.*, motherboard_store.motherboardstore AS brand_name, motherboard_brand.motherboardbrand AS processor_name
                  FROM motherboard
                  INNER JOIN motherboard_store ON motherboard.brand = motherboard_store.motherboardstore
                  INNER JOIN motherboard_brand ON motherboard.processor = motherboard_brand.motherboardbrand"
                  . $where_clause_string
...
?>
    ...
    <nav class="breadcrumb">
        <ul>
            ...
            <li>/</li>
            <li><a href="motherboard.php" class="active">Motherboards</a></li>
        </ul>
    </nav>
    ...
    <div class="ppcontainer">
        <!-- Left Sidebar -->
        <aside class="sidebar">
            <!-- Motherboard Products Filter -->
            <div class="filter-category">
                <button class="filter-toggle"><i class="fa-solid fa-caret-down"></i> Motherboards</button>
                <ul class="filter-list" style="display: none;">
                    <?php
                    $store_query = "SELECT DISTINCT motherboardstore FROM motherboard_store ORDER BY motherboardstore ASC";
                    ...
                    if (!$store_result) {
                        ...
                        while ($row = mysqli_fetch_assoc($store_result)) {
                            $original_value = $row['motherboardstore'];
            ...
            <div class="filter-category">
                ...
                <ul class="filter-list" style="display: none;">
                    <?php
                    $brand_query = "SELECT DISTINCT motherboardbrand FROM motherboard_brand ORDER BY created_at DESC";
                    ...
                    if (!$brand_result) {
                        ...
                        while ($row = mysqli_fetch_assoc($brand_result)) {
                            $original_value = $row['motherboardbrand'];
                            $display_value = htmlspecialchars($original_value, ENT_QUOTES);
                            $url_value = urlencode($original_value);
        ...
        <div class="main-content">
            <div class="product-grid">
                <div class="mainheading">
                    <h3 id="motherboard-heading">Motherboards<?php echo $selected_brand ? " >> " . htmlspecialchars($selected_brand) : ''; ?></h3>
                </div>
                <div class="pp">
                    <p>Shop a wide selection of Motherboards in Pakistan including various models at Czone.com.pk</p>
                </div>
                ...
                <?php while ($row = mysqli_fetch_assoc($product_result)): {
                    ...
                    <div class="product-container card" data-category="motherboards" data-id="<?php echo htmlspecialchars($row['id']); ?>">
                        ...
                        <div class="product-details">
                            ...
                            <p class="category"><strong>Category:</strong> Motherboards > <?php echo $brand; ?></p>
                        ...
                        <div class="product-right">
                            ...
                            <?php endif; ?>
                            <button class="add-to-cart" onclick="addToCart(<?php echo htmlspecialchars($row['id']); ?>, 'motherboard')">
            ...
            <!-- End Paragraph -->
            <div class="endpara">
                <p>Get consistent, high-quality performance with our wide range of Motherboards.</p>
                <p>From everyday computing to high-performance builds, we've got you covered with trusted brands like ASUS, MSI, and Gigabyte.</p>
                <p>Enjoy reliable performance and great value, all at competitive prices in Pakistan.</p>
            </div>
        </div>
    </div>

    <!-- Product Popup -->
    <div id="productPopup" class="popup" data-category="motherboards">
        <div class="popup-content">
            ...
            <div class="aside">
                ...
                <button class="add-to-cart" onclick="addToCart(0, 'motherboard')">
                    <i class="fa-solid fa-cart-shopping"></i> Add To Cart
                </button>
