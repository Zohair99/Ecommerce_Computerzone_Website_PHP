...
$title = 'Gaming Console Prices in Pakistan - Sony - XBOX';
...
$sort_order = "gamingconsoles.price ASC";
if (isset($_GET['sort'])) {
    switch ($_GET['sort']) {
        case "high":
            $sort_order = "gamingconsoles.price DESC";
            break;
        case "low":
            $sort_order = "gamingconsoles.price ASC";
            break;
        case "rating":
            $sort_order = "gamingconsoles.review DESC";
            break;
    }
}
...
$base_product_query = "SELECT gamingconsoles.*, gamingconsoles_store.gamingconsolesstore AS brand_name, gamingconsoles_brand.gamingconsolesbrand AS processor_name
                       FROM gamingconsoles
                       INNER JOIN gamingconsoles_store ON gamingconsoles.brand = gamingconsoles_store.gamingconsolesstore
                       INNER JOIN gamingconsoles_brand ON gamingconsoles.processor = gamingconsoles_brand.gamingconsolesbrand";
...
if (!empty($selected_brand)) {
    $conditions[] = "gamingconsoles_store.gamingconsolesstore = '" . $selected_brand . "'";
}
if (!empty($selected_processor)) {
    $conditions[] = "gamingconsoles_brand.gamingconsolesbrand = '" . $selected_processor . "'";
}
if (!empty($searchQuery)) {
    $conditions[] = "gamingconsoles.name LIKE '%" . $searchQuery . "%'";
}
...
?>
    ...
    <nav class="breadcrumb">
        <ul>
            ...
            <li>/</li>
            <li><a href="gamingconsoles.php" class="active">Gaming Console</a></li>
        </ul>
    </nav>
    ...
    <div class="ppcontainer">
        <!-- Left Sidebar -->
        <aside class="sidebar">
            <!-- Gaming Console Filter -->
            <div class="filter-category">
                <button class="filter-toggle"><i class="fa-solid fa-caret-down"></i> Gaming Console</button>
                <ul class="filter-list" style="display: none;">
                    <?php
                    $store_query = "SELECT DISTINCT gamingconsolesstore FROM gamingconsoles_store ORDER BY gamingconsolesstore ASC";
                    ...
                    if (!$store_result) {
                        ...
                        while ($row = mysqli_fetch_assoc($store_result)) {
                            $original_value = $row['gamingconsolesstore'];
            ...
            <div class="filter-category">
                ...
                <ul class="filter-list" style="display: none;">
                    <?php
                    $brand_query = "SELECT DISTINCT gamingconsolesbrand FROM gamingconsoles_brand ORDER BY created_at DESC";
                    ...
                    if (!$brand_result) {
                        ...
                        while ($row = mysqli_fetch_assoc($brand_result)) {
                            $original_value = $row['gamingconsolesbrand'];
                            $display_value = htmlspecialchars($original_value, ENT_QUOTES);
                            $url_value = urlencode($original_value);
        ...
        <div class="main-content">
            <div class="product-grid">
                <div class="mainheading">
                    <h3 id="gaming-heading">Gaming Console<?php echo $selected_brand ? " >> " . htmlspecialchars($selected_brand) : ''; ?></h3>
                </div>
                <div class="pp">
                    <p>Shop a wide selection of Gaming Consoles in Pakistan including various models at Czone.com.pk</p>
                </div>
                ...
                <?php while ($row = mysqli_fetch_assoc($product_result)): {
                    ...
                    <div class="product-container card" data-category="gaming-consoles" data-id="<?php echo htmlspecialchars($row['id']); ?>">
                        ...
                        <div class="product-details">
                            ...
                            <p class="category"><strong>Category:</strong> Gaming Consoles > <?php echo $brand; ?></p>
                        ...
                        <div class="product-right">
                            ...
                            <?php endif; ?>
                            <button class="add-to-cart" onclick="addToCart(<?php echo htmlspecialchars($row['id']); ?>, 'gamingconsoles')">
            ...
            <!-- End Paragraph -->
            <div class="endpara">
                <p>Experience immersive gaming with our wide range of Gaming Consoles from top brands.</p>
                <p>From casual gaming to professional esports, we've got you covered with the latest PlayStation, Xbox, and Nintendo consoles.</p>
                <p>Enjoy cutting-edge performance and exclusive games, all at competitive prices in Pakistan.</p>
            </div>
        </div>
    </div>

    <!-- Product Popup -->
    <div id="productPopup" class="popup" data-category="gaming-consoles">
        <div class="popup-content">
            ...
            <div class="aside">
                ...
                <button class="add-to-cart" onclick="addToCart(0, 'gamingconsoles')">
                    <i class="fa-solid fa-cart-shopping"></i> Add To Cart
                </button>
